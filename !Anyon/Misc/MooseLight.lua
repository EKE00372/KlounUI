...
if not C.MooseLight then return end
...
local zoneLightID = {
	...
	[2095] = true,	-- Infusion Chambers / 晶红，閃霜入侵點
...
local function OnEvent()
	...
	local inDepths = (instanceID == 2651) and subName[name]
	
	if not MapID then return end
	if inDepths then return end
